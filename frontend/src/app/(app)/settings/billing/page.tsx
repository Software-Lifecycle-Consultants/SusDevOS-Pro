...
const PLAN_FEATURES: Record<string, string[]> = {
  ...
  starter:      ["1 entity","5 users","All scopes","All factor libraries","SBTi targets","CSV export"],
  professional: ["5 entities","20 users","Verification workflow","CDP export","GIS mapping","API access"],
