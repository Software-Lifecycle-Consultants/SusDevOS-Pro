...
const STANDARDS = [
  ...
  },
  {
    ...
    dot:       "bg-sky-600",
    summary:   "CDP runs the world's largest environmental disclosure system. SusDevOS generates CDP-ready exports that map directly to the Climate Change questionnaire sections, eliminating hours of manual reformatting.",
    how: [
      "C6 (Scope 1 and 2 emissions) auto-populated from the verified GHG inventory for the relevant reporting year",
      "C7 (Scope 3 emissions) populated from Scope 3 category records with relevance justifications",
      "C10 (verification) populated from the verification workflow status, verifier details, and third-party sign-off timestamps",
      "Export format matches the CDP submission template column structure — paste directly into the CDP online system",
      "Multiple reporting years in the inventory allow year-over-year trend data required by CDP scoring",
    ],
    supplementary: ["CDP Climate Change 2024 Questionnaire Guidance"],
  },
  {
    id:        "tnfd",
    abbr:      "TNFD",
