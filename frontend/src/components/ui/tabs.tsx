...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-9 items-center justify-center rounded-md bg-surface-100 p-1 text-surface-500",
      className
    )}
    {...props}
  />
